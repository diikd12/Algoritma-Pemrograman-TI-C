...
bubble_data = python_data.copy()
selection_data = python_data.copy()

bubble_swap_count = 0
selection_swap_count = 0

for i in range (len(bubble_data)):
    for j in range (0, len(bubble_data)-i-1):
...
print ("bubble sort dari kecil ke besar: ", bubble_data)
print ("jumlah swap pada bubble sort: ", bubble_swap_count)
print (" ")
print ("selection sort dari besar ke kecil: ", selection_data)
print ("jumlah swap pada selection sort: ", selection_swap_count)